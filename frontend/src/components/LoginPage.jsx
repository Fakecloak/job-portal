...
function LoginPage() {
    ...
    const [message, formAction, isPending] = useActionState(login, "", {withPending:true});
  return (
    ...
    <div className="bg-gray-50 text-gray-800">
        ...
        <form action={formAction} className="mt-6 space-y-4">
            ...
            <div>
                ...
                <input type="text" placeholder="Enter your Username" name="username" required className="mt-1 w-full rounded border border-gray-300 px-3 py-2
            ...
            <div>
                ...
                <input type="password" placeholder="Enter your password" name="password" required className="mt-1 w-full rounded border border-gray-300 px-3 py-2
                        focus:border-blue-600 focus:ring-1 focus:ring-blue-200
                        outline-none" />
            </div>
